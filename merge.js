...
// 2. 定义地区过滤组
const regions = [
    { name: 'HK', icon: 'https://testingcf.jsdelivr.net/gh/Koolson/Qure@master/IconSet/Color/Hong_Kong.png', filter: '(?i)港|HK|hk|Hong Kong|HongKong|hongkong' },
    { name: 'JP', icon: 'https://testingcf.jsdelivr.net/gh/Koolson/Qure@master/IconSet/Color/Japan.png', filter: '(?i)日本|川日|东京|大阪|泉日|埼玉|沪日|深日|JP|Japan' },
    { name: 'SG', icon: 'https://testingcf.jsdelivr.net/gh/Koolson/Qure@master/IconSet/Color/Singapore.png', filter: '(?i)新加坡|坡|狮城|SG|Singapore' },
    { name: 'TW', icon: 'https://testingcf.jsdelivr.net/gh/Koolson/Qure@master/IconSet/Color/Taiwan.png', filter: '(?i)台|新北|彰化|TW|Taiwan' },
    { name: 'US', icon: 'https://testingcf.jsdelivr.net/gh/Koolson/Qure@master/IconSet/Color/United_States.png', filter: '(?i)美|波特兰|达拉斯|俄勒冈|凤凰城|费利蒙|硅谷|拉斯维加斯|洛杉矶|圣何塞|圣克拉拉|西雅图|芝加哥|US|United States' },
    { name: 'KR', icon: 'https://testingcf.jsdelivr.net/gh/Koolson/Qure@master/IconSet/Color/Korea.png', filter: '(?i)KR|Korea|KOR|首尔|韩|韓' }
];
...
function main(config) {
    ...
    let proxyGroups = [
        ...
        },
        {
            name: "Proxies",
            type: "select",
            proxies: ["手动切换", "自动选择", ...regions.map(r => r.name)],
    ...
    config.rules = [
        ...
        "DOMAIN,safebrowsing.googleapis-cn.com,DIRECT",
        "DOMAIN,safebrowsing.clients.google.com,DIRECT",
        "DOMAIN,safebrowsing-cache.google.com,DIRECT",
        ...
        "DOMAIN-SUFFIX,disneylandparis.com,Disney",
        ...
        "DOMAIN-SUFFIX,disneyprivacycenter.com,Disney",
        ...
        "DOMAIN-SUFFIX,disneytermsofuse.com,Disney",
        ...
        "DOMAIN-SUFFIX,dlp-media.com,Disney",
        ...
        "DOMAIN-SUFFIX,hotstar-cdn.net,Disney",
        "DOMAIN-SUFFIX,hotstar-labs.com,Disney",
        "DOMAIN-SUFFIX,hotstar.com,Disney",
        "DOMAIN-SUFFIX,hotstarext.com,Disney",
        "DOMAIN-SUFFIX,hsprepack.akamaized.net,Disney",
        ...
        "DOMAIN-SUFFIX,starott.com,Disney",
        "DOMAIN-SUFFIX,starplus.com,Disney",
        ...
        "DOMAIN-SUFFIX,thewaltdisneycompany.com,Disney",
        ...
        "DOMAIN,wmff.warnermediacdn.com,Hbomax",
        "DOMAIN-SUFFIX,h264.io,Hbomax",
        "DOMAIN-SUFFIX,hbo.com,Hbomax",
        "DOMAIN-SUFFIX,hbogo.com,Hbomax",
        "DOMAIN-SUFFIX,hbonow.com,Hbomax",
        "DOMAIN-SUFFIX,hbomax.com,Hbomax",
        "DOMAIN-SUFFIX,hbomaxcdn.com,Hbomax",
        "DOMAIN-SUFFIX,hbomaxdash.s.llnwi.net,Hbomax",
        "DOMAIN-SUFFIX,max.com,Hbomax",
        "DOMAIN-SUFFIX,maxgo.com,Hbomax",
        "DOMAIN-SUFFIX,cinemax.com,Hbomax",
        "DOMAIN-SUFFIX,discomax.com,Hbomax",
        "PROCESS-NAME,com.hbo.hbonow,Hbomax",
        ...
        "DOMAIN-SUFFIX,biliintl.co,Bilibili",
        ...
        "PROCESS-NAME,com.bilibili.app.blue,Bilibili",
        "PROCESS-NAME,com.bilibili.app.in,Bilibili",
        "PROCESS-NAME,com.bilibili.comic,Bilibili",
        "PROCESS-NAME,com.bilibili.comic.intl,Bilibili",
        "PROCESS-NAME,tv.danmaku.bili,Bilibili",
        "PROCESS-NAME,tv.danmaku.bilibilihd,Bilibili",
        ...
        "DOMAIN-SUFFIX,steammobile.akamaized.net,Steam",
        ...
        "DOMAIN-SUFFIX,mbrx.app,Telegram",
        ...
        "DOMAIN,voice.telephony.goog,Google",
        "DOMAIN-SUFFIX,0emm.com,Google",
        "DOMAIN-SUFFIX,1e100.net,Google",
        "DOMAIN-SUFFIX,1ucrs.com,Google",
        "DOMAIN-SUFFIX,265.com,Google",
        "DOMAIN-SUFFIX,2mdn-cn.net,Google",
        "DOMAIN-SUFFIX,2mdn.net,Google",
        "DOMAIN-SUFFIX,466453.com,Google",
        "DOMAIN-SUFFIX,abc.xyz,Google",
        "DOMAIN-SUFFIX,adgoogle.net,Google",
        "DOMAIN-SUFFIX,admeld.com,Google",
        "DOMAIN-SUFFIX,admob-cn.com,Google",
        "DOMAIN-SUFFIX,admob.com,Google",
        "DOMAIN-SUFFIX,adsense.com,Google",
        "DOMAIN-SUFFIX,adsensecustomsearchads.com,Google",
        "DOMAIN-SUFFIX,adsenseformobileapps.com,Google",
        "DOMAIN-SUFFIX,advertisercommunity.com,Google",
        "DOMAIN-SUFFIX,advertiserscommunity.com,Google",
        "DOMAIN-SUFFIX,adwords-community.com,Google",
        "DOMAIN-SUFFIX,adwords.com,Google",
        "DOMAIN-SUFFIX,adwordsexpress.com,Google",
        "DOMAIN-SUFFIX,amp.dev,Google",
        "DOMAIN-SUFFIX,ampproject.com,Google",
        "DOMAIN-SUFFIX,ampproject.net,Google",
        "DOMAIN-SUFFIX,ampproject.org,Google",
        "DOMAIN-SUFFIX,android.com,Google",
        "DOMAIN-SUFFIX,androidify.com,Google",
        "DOMAIN-SUFFIX,androidtv.com,Google",
        "DOMAIN-SUFFIX,angulardart.org,Google",
        "DOMAIN-SUFFIX,api.ai,Google",
        "DOMAIN-SUFFIX,apigee.com,Google",
        "DOMAIN-SUFFIX,app-analytics-services.com,Google",
        "DOMAIN-SUFFIX,app-measurement-cn.com,Google",
        "DOMAIN-SUFFIX,app-measurement.com,Google",
        "DOMAIN-SUFFIX,app-measurement.net,Google",
        "DOMAIN-SUFFIX,appbridge.ca,Google",
        "DOMAIN-SUFFIX,appbridge.io,Google",
        "DOMAIN-SUFFIX,appbridge.it,Google",
        "DOMAIN-SUFFIX,apps5.oingo.com,Google",
        "DOMAIN-SUFFIX,appspot.com,Google",
        "DOMAIN-SUFFIX,apture.com,Google",
        "DOMAIN-SUFFIX,area120.com,Google",
        "DOMAIN-SUFFIX,asp-cc.com,Google",
        "DOMAIN-SUFFIX,autodraw.com,Google",
        "DOMAIN-SUFFIX,avail.googleflights.net,Google",
        "DOMAIN-SUFFIX,bandpage.com,Google",
        "DOMAIN-SUFFIX,baselinestudy.com,Google",
        "DOMAIN-SUFFIX,baselinestudy.org,Google",
        "DOMAIN-SUFFIX,bazel.build,Google",
        "DOMAIN-SUFFIX,bdn.dev,Google",
        "DOMAIN-SUFFIX,beacons.gvt2.com,Google",
        "DOMAIN-SUFFIX,beacons2.gvt2.com,Google",
        "DOMAIN-SUFFIX,beacons3.gvt2.com,Google",
        "DOMAIN-SUFFIX,beatthatquote.com,Google",
        "DOMAIN-SUFFIX,blink.org,Google",
        "DOMAIN-SUFFIX,blog.google,Google",
        "DOMAIN-SUFFIX,blogblog.com,Google",
        "DOMAIN-SUFFIX,blogger.com,Google",
        "DOMAIN-SUFFIX,blogspot.ae,Google",
        "DOMAIN-SUFFIX,blogspot.al,Google",
        "DOMAIN-SUFFIX,blogspot.am,Google",
        "DOMAIN-SUFFIX,blogspot.ba,Google",
        "DOMAIN-SUFFIX,blogspot.be,Google",
        "DOMAIN-SUFFIX,blogspot.bg,Google",
        "DOMAIN-SUFFIX,blogspot.bj,Google",
        "DOMAIN-SUFFIX,blogspot.ca,Google",
        "DOMAIN-SUFFIX,blogspot.cf,Google",
        "DOMAIN-SUFFIX,blogspot.ch,Google",
        "DOMAIN-SUFFIX,blogspot.cl,Google",
        "DOMAIN-SUFFIX,blogspot.co.at,Google",
        "DOMAIN-SUFFIX,blogspot.co.id,Google",
        "DOMAIN-SUFFIX,blogspot.co.il,Google",
        "DOMAIN-SUFFIX,blogspot.co.ke,Google",
        "DOMAIN-SUFFIX,blogspot.co.nz,Google",
        "DOMAIN-SUFFIX,blogspot.co.uk,Google",
        "DOMAIN-SUFFIX,blogspot.co.za,Google",
        "DOMAIN-SUFFIX,blogspot.com,Google",
        "DOMAIN-SUFFIX,blogspot.com.ar,Google",
        "DOMAIN-SUFFIX,blogspot.com.au,Google",
        "DOMAIN-SUFFIX,blogspot.com.br,Google",
        "DOMAIN-SUFFIX,blogspot.com.by,Google",
        "DOMAIN-SUFFIX,blogspot.com.co,Google",
        "DOMAIN-SUFFIX,blogspot.com.cy,Google",
        "DOMAIN-SUFFIX,blogspot.com.ee,Google",
        "DOMAIN-SUFFIX,blogspot.com.eg,Google",
        "DOMAIN-SUFFIX,blogspot.com.es,Google",
        "DOMAIN-SUFFIX,blogspot.com.mt,Google",
        "DOMAIN-SUFFIX,blogspot.com.ng,Google",
        "DOMAIN-SUFFIX,blogspot.com.tr,Google",
        "DOMAIN-SUFFIX,blogspot.com.uy,Google",
        "DOMAIN-SUFFIX,blogspot.cv,Google",
        "DOMAIN-SUFFIX,blogspot.cz,Google",
        "DOMAIN-SUFFIX,blogspot.de,Google",
        "DOMAIN-SUFFIX,blogspot.dk,Google",
        "DOMAIN-SUFFIX,blogspot.fi,Google",
        "DOMAIN-SUFFIX,blogspot.fr,Google",
        "DOMAIN-SUFFIX,blogspot.gr,Google",
        "DOMAIN-SUFFIX,blogspot.hk,Google",
        "DOMAIN-SUFFIX,blogspot.hr,Google",
        "DOMAIN-SUFFIX,blogspot.hu,Google",
        "DOMAIN-SUFFIX,blogspot.ie,Google",
        "DOMAIN-SUFFIX,blogspot.in,Google",
        "DOMAIN-SUFFIX,blogspot.is,Google",
        "DOMAIN-SUFFIX,blogspot.it,Google",
        "DOMAIN-SUFFIX,blogspot.jp,Google",
        "DOMAIN-SUFFIX,blogspot.kr,Google",
        "DOMAIN-SUFFIX,blogspot.li,Google",
        "DOMAIN-SUFFIX,blogspot.lt,Google",
        "DOMAIN-SUFFIX,blogspot.lu,Google",
        "DOMAIN-SUFFIX,blogspot.md,Google",
        "DOMAIN-SUFFIX,blogspot.mk,Google",
        "DOMAIN-SUFFIX,blogspot.mx,Google",
        "DOMAIN-SUFFIX,blogspot.my,Google",
        "DOMAIN-SUFFIX,blogspot.nl,Google",
        "DOMAIN-SUFFIX,blogspot.no,Google",
        "DOMAIN-SUFFIX,blogspot.pe,Google",
        "DOMAIN-SUFFIX,blogspot.pt,Google",
        "DOMAIN-SUFFIX,blogspot.qa,Google",
        "DOMAIN-SUFFIX,blogspot.re,Google",
        "DOMAIN-SUFFIX,blogspot.ro,Google",
        "DOMAIN-SUFFIX,blogspot.rs,Google",
        "DOMAIN-SUFFIX,blogspot.ru,Google",
        "DOMAIN-SUFFIX,blogspot.se,Google",
        "DOMAIN-SUFFIX,blogspot.sg,Google",
        "DOMAIN-SUFFIX,blogspot.si,Google",
        "DOMAIN-SUFFIX,blogspot.sk,Google",
        "DOMAIN-SUFFIX,blogspot.sn,Google",
        "DOMAIN-SUFFIX,blogspot.td,Google",
        "DOMAIN-SUFFIX,blogspot.tw,Google",
        "DOMAIN-SUFFIX,blogspot.ug,Google",
        "DOMAIN-SUFFIX,blogspot.vn,Google",
        "DOMAIN-SUFFIX,brocaproject.com,Google",
        "DOMAIN-SUFFIX,brotli.org,Google",
        "DOMAIN-SUFFIX,bumpshare.com,Google",
        "DOMAIN-SUFFIX,bumptop.ca,Google",
        "DOMAIN-SUFFIX,bumptop.com,Google",
        "DOMAIN-SUFFIX,bumptop.net,Google",
        "DOMAIN-SUFFIX,bumptop.org,Google",
        "DOMAIN-SUFFIX,bumptunes.com,Google",
        "DOMAIN-SUFFIX,campuslondon.com,Google",
        "DOMAIN-SUFFIX,capitalg.com,Google",
        "DOMAIN-SUFFIX,certificate-transparency.dev,Google",
        "DOMAIN-SUFFIX,certificate-transparency.org,Google",
        "DOMAIN-SUFFIX,charlestonroadregistry.com,Google",
        "DOMAIN-SUFFIX,chat.gle,Google",
        "DOMAIN-SUFFIX,chrome.com,Google",
        "DOMAIN-SUFFIX,chromebook.com,Google",
        "DOMAIN-SUFFIX,chromecast.com,Google",
        "DOMAIN-SUFFIX,chromeexperiments.com,Google",
        "DOMAIN-SUFFIX,chromeos.dev,Google",
        "DOMAIN-SUFFIX,chromercise.com,Google",
        "DOMAIN-SUFFIX,chromestatus.com,Google",
        "DOMAIN-SUFFIX,chromium.org,Google",
        "DOMAIN-SUFFIX,chronicle.security,Google",
        "DOMAIN-SUFFIX,chroniclesec.com,Google",
        "DOMAIN-SUFFIX,clickserve.cc-dt.com,Google",
        "DOMAIN-SUFFIX,clickserver.googleads.com,Google",
        "DOMAIN-SUFFIX,cloudburstresearch.com,Google",
        "DOMAIN-SUFFIX,cloudfunctions.net,Google",
        "DOMAIN-SUFFIX,cloudproxy.app,Google",
        "DOMAIN-SUFFIX,cloudrobotics.com,Google",
        "DOMAIN-SUFFIX,cobrasearch.com,Google",
        "DOMAIN-SUFFIX,codespot.com,Google",
        "DOMAIN-SUFFIX,conscrypt.com,Google",
        "DOMAIN-SUFFIX,conscrypt.org,Google",
        "DOMAIN-SUFFIX,cookiechoices.org,Google",
        "DOMAIN-SUFFIX,coova.com,Google",
        "DOMAIN-SUFFIX,coova.net,Google",
        "DOMAIN-SUFFIX,coova.org,Google",
        "DOMAIN-SUFFIX,crashlytics.com,Google",
        "DOMAIN-SUFFIX,crbug.com,Google",
        "DOMAIN-SUFFIX,creativelab5.com,Google",
        "DOMAIN-SUFFIX,crossmediapanel.com,Google",
        "DOMAIN-SUFFIX,crr.com,Google",
        "DOMAIN-SUFFIX,crrev.com,Google",
        "DOMAIN-SUFFIX,cs4hs.com,Google",
        "DOMAIN-SUFFIX,dart.dev,Google",
        "DOMAIN-SUFFIX,dartlang.org,Google",
        "DOMAIN-SUFFIX,dartpad.dev,Google",
        "DOMAIN-SUFFIX,dartsearch-cn.net,Google",
        "DOMAIN-SUFFIX,dartsearch.net,Google",
        "DOMAIN-SUFFIX,data-vocabulary.org,Google",
        "DOMAIN-SUFFIX,dataliberation.org,Google",
        "DOMAIN-SUFFIX,debug.com,Google",
        "DOMAIN-SUFFIX,debugproject.com,Google",
        "DOMAIN-SUFFIX,deepmind.com,Google",
        "DOMAIN-SUFFIX,deja.com,Google",
        "DOMAIN-SUFFIX,deps.dev,Google",
        "DOMAIN-SUFFIX,deps.info,Google",
        "DOMAIN-SUFFIX,devsitetest.how,Google",
        "DOMAIN-SUFFIX,dialogflow.com,Google",
        "DOMAIN-SUFFIX,digisfera.com,Google",
        "DOMAIN-SUFFIX,digitalassetlinks.org,Google",
        "DOMAIN-SUFFIX,digitalattackmap.com,Google",
        "DOMAIN-SUFFIX,doubleclick-cn.net,Google",
        "DOMAIN-SUFFIX,doubleclick.com,Google",
        "DOMAIN-SUFFIX,doubleclick.net,Google",
        "DOMAIN-SUFFIX,download.qatp1.net,Google",
        "DOMAIN-SUFFIX,episodic.com,Google",
        "DOMAIN-SUFFIX,fastlane.ci,Google",
        "DOMAIN-SUFFIX,fastlane.tools,Google",
        "DOMAIN-SUFFIX,feedburner.com,Google",
        "DOMAIN-SUFFIX,fflick.com,Google",
        "DOMAIN-SUFFIX,financeleadsonline.com,Google",
        "DOMAIN-SUFFIX,firebaseapp.com,Google",
        "DOMAIN-SUFFIX,firebaseio.com,Google",
        "DOMAIN-SUFFIX,flutter.dev,Google",
        "DOMAIN-SUFFIX,flutterapp.com,Google",
        "DOMAIN-SUFFIX,foofle.com,Google",
        "DOMAIN-SUFFIX,froogle.com,Google",
        "DOMAIN-SUFFIX,fuchsia.dev,Google",
        "DOMAIN-SUFFIX,g-tun.com,Google",
        "DOMAIN-SUFFIX,g.co,Google",
        "DOMAIN-SUFFIX,g.dev,Google",
        "DOMAIN-SUFFIX,g.page,Google",
        "DOMAIN-SUFFIX,gateway.dev,Google",
        "DOMAIN-SUFFIX,gcp.gvt2.com,Google",
        "DOMAIN-SUFFIX,gcr.io,Google",
        "DOMAIN-SUFFIX,gerritcodereview.com,Google",
        "DOMAIN-SUFFIX,get.app,Google",
        "DOMAIN-SUFFIX,get.dev,Google",
        "DOMAIN-SUFFIX,get.how,Google",
        "DOMAIN-SUFFIX,get.page,Google",
        "DOMAIN-SUFFIX,getbumptop.com,Google",
        "DOMAIN-SUFFIX,getmdl.io,Google",
        "DOMAIN-SUFFIX,getoutline.org,Google",
        "DOMAIN-SUFFIX,ggoogle.com,Google",
        "DOMAIN-SUFFIX,gipscorp.com,Google",
        "DOMAIN-SUFFIX,globaledu.org,Google",
        "DOMAIN-SUFFIX,gmail.com,Google",
        "DOMAIN-SUFFIX,gmodules.com,Google",
        "DOMAIN-SUFFIX,go-lang.com,Google",
        "DOMAIN-SUFFIX,go-lang.net,Google",
        "DOMAIN-SUFFIX,go-lang.org,Google",
        "DOMAIN-SUFFIX,go.dev,Google",
        "DOMAIN-SUFFIX,godoc.org,Google",
        "DOMAIN-SUFFIX,gogle.com,Google",
        "DOMAIN-SUFFIX,gogole.com,Google",
        "DOMAIN-SUFFIX,golang.com,Google",
        "DOMAIN-SUFFIX,golang.net,Google",
        "DOMAIN-SUFFIX,golang.org,Google",
        "DOMAIN-SUFFIX,gonglchuangl.net,Google",
        "DOMAIN-SUFFIX,gongyichuangyi.net,Google",
        "DOMAIN-SUFFIX,goo.gl,Google",
        "DOMAIN-SUFFIX,alt1-mtalk.google.com,Google",
        "DOMAIN-SUFFIX,alt2-mtalk.google.com,Google",
        "DOMAIN-SUFFIX,alt3-mtalk.google.com,Google",
        "DOMAIN-SUFFIX,alt4-mtalk.google.com,Google",
        "DOMAIN-SUFFIX,alt5-mtalk.google.com,Google",
        "DOMAIN-SUFFIX,alt6-mtalk.google.com,Google",
        "DOMAIN-SUFFIX,alt7-mtalk.google.com,Google",
        "DOMAIN-SUFFIX,alt8-mtalk.google.com,Google",
        "DOMAIN-SUFFIX,mtalk.google.com,Google",
        "DOMAIN-SUFFIX,mtalk4.google.com,Google",
        "DOMAIN-SUFFIX,mtalk-staging.google.com,Google",
        "DOMAIN-SUFFIX,mtalk-dev.google.com,Google",
        "DOMAIN-SUFFIX,googel.com,Google",
        "DOMAIN-SUFFIX,googil.com,Google",
        "DOMAIN-SUFFIX,googl.com,Google",
        "DOMAIN-SUFFIX,google-analytics-cn.com,Google",
        "DOMAIN-SUFFIX,google-analytics.com,Google",
        "DOMAIN-SUFFIX,google-syndication.com,Google",
        "DOMAIN-SUFFIX,google.ad,Google",
        "DOMAIN-SUFFIX,google.ae,Google",
        "DOMAIN-SUFFIX,google.al,Google",
        "DOMAIN-SUFFIX,google.am,Google",
        "DOMAIN-SUFFIX,google.as,Google",
        "DOMAIN-SUFFIX,google.at,Google",
        "DOMAIN-SUFFIX,google.az,Google",
        "DOMAIN-SUFFIX,google.ba,Google",
        "DOMAIN-SUFFIX,google.be,Google",
        "DOMAIN-SUFFIX,google.berlin,Google",
        "DOMAIN-SUFFIX,google.bf,Google",
        "DOMAIN-SUFFIX,google.bg,Google",
        "DOMAIN-SUFFIX,google.bi,Google",
        "DOMAIN-SUFFIX,google.bj,Google",
        "DOMAIN-SUFFIX,google.bs,Google",
        "DOMAIN-SUFFIX,google.bt,Google",
        "DOMAIN-SUFFIX,google.by,Google",
        "DOMAIN-SUFFIX,google.ca,Google",
        "DOMAIN-SUFFIX,google.cat,Google",
        "DOMAIN-SUFFIX,google.cd,Google",
        "DOMAIN-SUFFIX,google.cf,Google",
        "DOMAIN-SUFFIX,google.cg,Google",
        "DOMAIN-SUFFIX,google.ch,Google",
        "DOMAIN-SUFFIX,google.ci,Google",
        "DOMAIN-SUFFIX,google.cl,Google",
        "DOMAIN-SUFFIX,google.cm,Google",
        "DOMAIN-SUFFIX,google.co.ao,Google",
        "DOMAIN-SUFFIX,google.co.bw,Google",
        "DOMAIN-SUFFIX,google.co.ck,Google",
        "DOMAIN-SUFFIX,google.co.cr,Google",
        "DOMAIN-SUFFIX,google.co.id,Google",
        "DOMAIN-SUFFIX,google.co.il,Google",
        "DOMAIN-SUFFIX,google.co.in,Google",
        "DOMAIN-SUFFIX,google.co.jp,Google",
        "DOMAIN-SUFFIX,google.co.ke,Google",
        "DOMAIN-SUFFIX,google.co.kr,Google",
        "DOMAIN-SUFFIX,google.co.ls,Google",
        "DOMAIN-SUFFIX,google.co.ma,Google",
        "DOMAIN-SUFFIX,google.co.mz,Google",
        "DOMAIN-SUFFIX,google.co.nz,Google",
        "DOMAIN-SUFFIX,google.co.th,Google",
        "DOMAIN-SUFFIX,google.co.tz,Google",
        "DOMAIN-SUFFIX,google.co.ug,Google",
        "DOMAIN-SUFFIX,google.co.uk,Google",
        "DOMAIN-SUFFIX,google.co.uz,Google",
        "DOMAIN-SUFFIX,google.co.ve,Google",
        "DOMAIN-SUFFIX,google.co.vi,Google",
        "DOMAIN-SUFFIX,google.co.za,Google",
        "DOMAIN-SUFFIX,google.co.zm,Google",
        "DOMAIN-SUFFIX,google.co.zw,Google",
        "DOMAIN-SUFFIX,google.com,Google",
        "DOMAIN-SUFFIX,google.com.af,Google",
        "DOMAIN-SUFFIX,google.com.ag,Google",
        "DOMAIN-SUFFIX,google.com.ai,Google",
        "DOMAIN-SUFFIX,google.com.ar,Google",
        "DOMAIN-SUFFIX,google.com.au,Google",
        "DOMAIN-SUFFIX,google.com.bd,Google",
        "DOMAIN-SUFFIX,google.com.bh,Google",
        "DOMAIN-SUFFIX,google.com.bn,Google",
        "DOMAIN-SUFFIX,google.com.bo,Google",
        "DOMAIN-SUFFIX,google.com.br,Google",
        "DOMAIN-SUFFIX,google.com.bz,Google",
        "DOMAIN-SUFFIX,google.com.co,Google",
        "DOMAIN-SUFFIX,google.com.cu,Google",
        "DOMAIN-SUFFIX,google.com.cy,Google",
        "DOMAIN-SUFFIX,google.com.do,Google",
        "DOMAIN-SUFFIX,google.com.ec,Google",
        "DOMAIN-SUFFIX,google.com.eg,Google",
        "DOMAIN-SUFFIX,google.com.et,Google",
        "DOMAIN-SUFFIX,google.com.fj,Google",
        "DOMAIN-SUFFIX,google.com.gh,Google",
        "DOMAIN-SUFFIX,google.com.gi,Google",
        "DOMAIN-SUFFIX,google.com.gt,Google",
        "DOMAIN-SUFFIX,google.com.hk,Google",
        "DOMAIN-SUFFIX,google.com.jm,Google",
        "DOMAIN-SUFFIX,google.com.kh,Google",
        "DOMAIN-SUFFIX,google.com.kw,Google",
        "DOMAIN-SUFFIX,google.com.lb,Google",
        "DOMAIN-SUFFIX,google.com.ly,Google",
        "DOMAIN-SUFFIX,google.com.mm,Google",
        "DOMAIN-SUFFIX,google.com.mt,Google",
        "DOMAIN-SUFFIX,google.com.mx,Google",
        "DOMAIN-SUFFIX,google.com.my,Google",
        "DOMAIN-SUFFIX,google.com.na,Google",
        "DOMAIN-SUFFIX,google.com.ng,Google",
        "DOMAIN-SUFFIX,google.com.ni,Google",
        "DOMAIN-SUFFIX,google.com.np,Google",
        "DOMAIN-SUFFIX,google.com.om,Google",
        "DOMAIN-SUFFIX,google.com.pa,Google",
        "DOMAIN-SUFFIX,google.com.pe,Google",
        "DOMAIN-SUFFIX,google.com.pg,Google",
        "DOMAIN-SUFFIX,google.com.ph,Google",
        "DOMAIN-SUFFIX,google.com.pk,Google",
        "DOMAIN-SUFFIX,google.com.pr,Google",
        "DOMAIN-SUFFIX,google.com.py,Google",
        "DOMAIN-SUFFIX,google.com.qa,Google",
        "DOMAIN-SUFFIX,google.com.sa,Google",
        "DOMAIN-SUFFIX,google.com.sb,Google",
        "DOMAIN-SUFFIX,google.com.sg,Google",
        "DOMAIN-SUFFIX,google.com.sl,Google",
        "DOMAIN-SUFFIX,google.com.sv,Google",
        "DOMAIN-SUFFIX,google.com.tj,Google",
        "DOMAIN-SUFFIX,google.com.tr,Google",
        "DOMAIN-SUFFIX,google.com.tw,Google",
        "DOMAIN-SUFFIX,google.com.ua,Google",
        "DOMAIN-SUFFIX,google.com.uy,Google",
        "DOMAIN-SUFFIX,google.com.vc,Google",
        "DOMAIN-SUFFIX,google.com.vn,Google",
        "DOMAIN-SUFFIX,google.cv,Google",
        "DOMAIN-SUFFIX,google.cz,Google",
        "DOMAIN-SUFFIX,google.de,Google",
        "DOMAIN-SUFFIX,google.dev,Google",
        "DOMAIN-SUFFIX,google.dj,Google",
        "DOMAIN-SUFFIX,google.dk,Google",
        "DOMAIN-SUFFIX,google.dm,Google",
        "DOMAIN-SUFFIX,google.dz,Google",
        "DOMAIN-SUFFIX,google.ee,Google",
        "DOMAIN-SUFFIX,google.es,Google",
        "DOMAIN-SUFFIX,google.fi,Google",
        "DOMAIN-SUFFIX,google.fm,Google",
        "DOMAIN-SUFFIX,google.fr,Google",
        "DOMAIN-SUFFIX,google.ga,Google",
        "DOMAIN-SUFFIX,google.ge,Google",
        "DOMAIN-SUFFIX,google.gg,Google",
        "DOMAIN-SUFFIX,google.gl,Google",
        "DOMAIN-SUFFIX,google.gm,Google",
        "DOMAIN-SUFFIX,google.gr,Google",
        "DOMAIN-SUFFIX,google.gy,Google",
        "DOMAIN-SUFFIX,google.hn,Google",
        "DOMAIN-SUFFIX,google.hr,Google",
        "DOMAIN-SUFFIX,google.ht,Google",
        "DOMAIN-SUFFIX,google.hu,Google",
        "DOMAIN-SUFFIX,google.ie,Google",
        "DOMAIN-SUFFIX,google.im,Google",
        "DOMAIN-SUFFIX,google.iq,Google",
        "DOMAIN-SUFFIX,google.is,Google",
        "DOMAIN-SUFFIX,google.it,Google",
        "DOMAIN-SUFFIX,google.je,Google",
        "DOMAIN-SUFFIX,google.jo,Google",
        "DOMAIN-SUFFIX,google.kg,Google",
        "DOMAIN-SUFFIX,google.ki,Google",
        "DOMAIN-SUFFIX,google.kz,Google",
        "DOMAIN-SUFFIX,google.la,Google",
        "DOMAIN-SUFFIX,google.li,Google",
        "DOMAIN-SUFFIX,google.lk,Google",
        "DOMAIN-SUFFIX,google.lt,Google",
        "DOMAIN-SUFFIX,google.lu,Google",
        "DOMAIN-SUFFIX,google.lv,Google",
        "DOMAIN-SUFFIX,google.md,Google",
        "DOMAIN-SUFFIX,google.me,Google",
        "DOMAIN-SUFFIX,google.mg,Google",
        "DOMAIN-SUFFIX,google.mk,Google",
        "DOMAIN-SUFFIX,google.ml,Google",
        "DOMAIN-SUFFIX,google.mn,Google",
        "DOMAIN-SUFFIX,google.ms,Google",
        "DOMAIN-SUFFIX,google.mu,Google",
        "DOMAIN-SUFFIX,google.mv,Google",
        "DOMAIN-SUFFIX,google.mw,Google",
        "DOMAIN-SUFFIX,google.ne,Google",
        "DOMAIN-SUFFIX,google.net,Google",
        "DOMAIN-SUFFIX,google.nl,Google",
        "DOMAIN-SUFFIX,google.no,Google",
        "DOMAIN-SUFFIX,google.nr,Google",
        "DOMAIN-SUFFIX,google.nu,Google",
        "DOMAIN-SUFFIX,google.org,Google",
        "DOMAIN-SUFFIX,google.pl,Google",
        "DOMAIN-SUFFIX,google.pn,Google",
        "DOMAIN-SUFFIX,google.ps,Google",
        "DOMAIN-SUFFIX,google.pt,Google",
        "DOMAIN-SUFFIX,google.ro,Google",
        "DOMAIN-SUFFIX,google.rs,Google",
        "DOMAIN-SUFFIX,google.ru,Google",
        "DOMAIN-SUFFIX,google.rw,Google",
        "DOMAIN-SUFFIX,google.sc,Google",
        "DOMAIN-SUFFIX,google.se,Google",
        "DOMAIN-SUFFIX,google.sh,Google",
        "DOMAIN-SUFFIX,google.si,Google",
        "DOMAIN-SUFFIX,google.sk,Google",
        "DOMAIN-SUFFIX,google.sm,Google",
        "DOMAIN-SUFFIX,google.sn,Google",
        "DOMAIN-SUFFIX,google.so,Google",
        "DOMAIN-SUFFIX,google.sr,Google",
        "DOMAIN-SUFFIX,google.st,Google",
        "DOMAIN-SUFFIX,google.td,Google",
        "DOMAIN-SUFFIX,google.tg,Google",
        "DOMAIN-SUFFIX,google.tl,Google",
        "DOMAIN-SUFFIX,google.tm,Google",
        "DOMAIN-SUFFIX,google.tn,Google",
        "DOMAIN-SUFFIX,google.to,Google",
        "DOMAIN-SUFFIX,google.tt,Google",
        "DOMAIN-SUFFIX,google.ventures,Google",
        "DOMAIN-SUFFIX,google.vg,Google",
        "DOMAIN-SUFFIX,google.vu,Google",
        "DOMAIN-SUFFIX,google.ws,Google",
        "DOMAIN-SUFFIX,googleacquisitionmigration.com,Google",
        "DOMAIN-SUFFIX,googleadapis.com,Google",
        "DOMAIN-SUFFIX,googleadservices-cn.com,Google",
        "DOMAIN-SUFFIX,googleadservices.com,Google",
        "DOMAIN-SUFFIX,googleanalytics.com,Google",
        "DOMAIN-SUFFIX,googleapis-cn.com,Google",
        "DOMAIN-SUFFIX,googleapis.com,Google",
        "DOMAIN-SUFFIX,googleapps-cn.com,Google",
        "DOMAIN-SUFFIX,googleapps.com,Google",
        "DOMAIN-SUFFIX,googlearth.com,Google",
        "DOMAIN-SUFFIX,googleblog.com,Google",
        "DOMAIN-SUFFIX,googlebot.com,Google",
        "DOMAIN-SUFFIX,googlecapital.com,Google",
        "DOMAIN-SUFFIX,googlecert.net,Google",
        "DOMAIN-SUFFIX,googlecode.com,Google",
        "DOMAIN-SUFFIX,googlecommerce.com,Google",
        "DOMAIN-SUFFIX,googlecompare.co.uk,Google",
        "DOMAIN-SUFFIX,googledanmark.com,Google",
        "DOMAIN-SUFFIX,googledomains.com,Google",
        "DOMAIN-SUFFIX,googlee.com,Google",
        "DOMAIN-SUFFIX,googleearth.com,Google",
        "DOMAIN-SUFFIX,googlefiber.com,Google",
        "DOMAIN-SUFFIX,googlefiber.net,Google",
        "DOMAIN-SUFFIX,googlefinland.com,Google",
        "DOMAIN-SUFFIX,googleflights-cn.net,Google",
        "DOMAIN-SUFFIX,googlemail.com,Google",
        "DOMAIN-SUFFIX,googlemaps.com,Google",
        "DOMAIN-SUFFIX,googlemashups.com,Google",
        "DOMAIN-SUFFIX,googleoptimize-cn.com,Google",
        "DOMAIN-SUFFIX,googleoptimize.com,Google",
        "DOMAIN-SUFFIX,googlepagecreator.com,Google",
        "DOMAIN-SUFFIX,googlephotos.com,Google",
        "DOMAIN-SUFFIX,googleplay.com,Google",
        "DOMAIN-SUFFIX,googleplus.com,Google",
        "DOMAIN-SUFFIX,googlescholar.com,Google",
        "DOMAIN-SUFFIX,googlesource.com,Google",
        "DOMAIN-SUFFIX,googlestore.com,Google",
        "DOMAIN-SUFFIX,googlesverige.com,Google",
        "DOMAIN-SUFFIX,googlesyndication-cn.com,Google",
        "DOMAIN-SUFFIX,googlesyndication.com,Google",
        "DOMAIN-SUFFIX,googletagmanager-cn.com,Google",
        "DOMAIN-SUFFIX,googletagmanager.com,Google",
        "DOMAIN-SUFFIX,googletagservices-cn.com,Google",
        "DOMAIN-SUFFIX,googletagservices.com,Google",
        "DOMAIN-SUFFIX,googletraveladservices-cn.com,Google",
        "DOMAIN-SUFFIX,googletraveladservices.com,Google",
        "DOMAIN-SUFFIX,googlevads-cn.com,Google",
        "DOMAIN-SUFFIX,googleventures.com,Google",
        "DOMAIN-SUFFIX,googlr.com,Google",
        "DOMAIN-SUFFIX,goolge.com,Google",
        "DOMAIN-SUFFIX,gooogle.com,Google",
        "DOMAIN-SUFFIX,gridaware.app,Google",
        "DOMAIN-SUFFIX,gsrc.io,Google",
        "DOMAIN-SUFFIX,gstatic-cn.com,Google",
        "DOMAIN-SUFFIX,gstatic.com,Google",
        "DOMAIN-SUFFIX,gsuite.com,Google",
        "DOMAIN-SUFFIX,gv.com,Google",
        "DOMAIN-SUFFIX,gvt0.com,Google",
        "DOMAIN-SUFFIX,gvt1-cn.com,Google",
        "DOMAIN-SUFFIX,gvt2-cn.com,Google",
        "DOMAIN-SUFFIX,gvt3.com,Google",
        "DOMAIN-SUFFIX,gvt5.com,Google",
        "DOMAIN-SUFFIX,gvt6.com,Google",
        "DOMAIN-SUFFIX,gvt7.com,Google",
        "DOMAIN-SUFFIX,gvt9.com,Google",
        "DOMAIN-SUFFIX,gwtproject.org,Google",
        "DOMAIN-SUFFIX,hdrplusdata.org,Google",
        "DOMAIN-SUFFIX,hey.gle,Google",
        "DOMAIN-SUFFIX,hindiweb.com,Google",
        "DOMAIN-SUFFIX,howtogetmo.co.uk,Google",
        "DOMAIN-SUFFIX,html5rocks.com,Google",
        "DOMAIN-SUFFIX,hwgo.com,Google",
        "DOMAIN-SUFFIX,iam.soy,Google",
        "DOMAIN-SUFFIX,iamremarkable.org,Google",
        "DOMAIN-SUFFIX,igoogle.com,Google",
        "DOMAIN-SUFFIX,impermium.com,Google",
        "DOMAIN-SUFFIX,itasoftware.com,Google",
        "DOMAIN-SUFFIX,j2objc.org,Google",
        "DOMAIN-SUFFIX,jibemobile.com,Google",
        "DOMAIN-SUFFIX,kaggle.com,Google",
        "DOMAIN-SUFFIX,kaggle.io,Google",
        "DOMAIN-SUFFIX,keyhole.com,Google",
        "DOMAIN-SUFFIX,keytransparency.com,Google",
        "DOMAIN-SUFFIX,keytransparency.foo,Google",
        "DOMAIN-SUFFIX,keytransparency.org,Google",
        "DOMAIN-SUFFIX,lanternal.com,Google",
        "DOMAIN-SUFFIX,like.com,Google",
        "DOMAIN-SUFFIX,madewithcode.com,Google",
        "DOMAIN-SUFFIX,material.io,Google",
        "DOMAIN-SUFFIX,mdialog.com,Google",
        "DOMAIN-SUFFIX,meet.new,Google",
        "DOMAIN-SUFFIX,mfg-inspector.com,Google",
        "DOMAIN-SUFFIX,mobileview.page,Google",
        "DOMAIN-SUFFIX,monitoring.qpdp1.net,Google",
        "DOMAIN-SUFFIX,moodstocks.com,Google",
        "DOMAIN-SUFFIX,near.by,Google",
        "DOMAIN-SUFFIX,nest.com,Google",
        "DOMAIN-SUFFIX,neverware.com,Google",
        "DOMAIN-SUFFIX,nomulus.foo,Google",
        "DOMAIN-SUFFIX,oasisfeng.com,Google",
        "DOMAIN-SUFFIX,oauthz.com,Google",
        "DOMAIN-SUFFIX,ok.gle,Google",
        "DOMAIN-SUFFIX,on.here,Google",
        "DOMAIN-SUFFIX,on2.com,Google",
        "DOMAIN-SUFFIX,onefifteen.net,Google",
        "DOMAIN-SUFFIX,onefifteen.org,Google",
        "DOMAIN-SUFFIX,oneworldmanystories.com,Google",
        "DOMAIN-SUFFIX,opensourceinsight.dev,Google",
        "DOMAIN-SUFFIX,opensourceinsights.dev,Google",
        "DOMAIN-SUFFIX,openthread.io,Google",
        "DOMAIN-SUFFIX,openweave.io,Google",
        "DOMAIN-SUFFIX,orbitera.com,Google",
        "DOMAIN-SUFFIX,page.link,Google",
        "DOMAIN-SUFFIX,pagespeedmobilizer.com,Google",
        "DOMAIN-SUFFIX,pageview.mobi,Google",
        "DOMAIN-SUFFIX,panoramio.com,Google",
        "DOMAIN-SUFFIX,partylikeits1986.org,Google",
        "DOMAIN-SUFFIX,paxlicense.org,Google",
        "DOMAIN-SUFFIX,picasa.com,Google",
        "DOMAIN-SUFFIX,picasaweb.com,Google",
        "DOMAIN-SUFFIX,picasaweb.net,Google",
        "DOMAIN-SUFFIX,picasaweb.org,Google",
        "DOMAIN-SUFFIX,picnik.com,Google",
        "DOMAIN-SUFFIX,pittpatt.com,Google",
        "DOMAIN-SUFFIX,pixate.com,Google",
        "DOMAIN-SUFFIX,pki.goog,Google",
        "DOMAIN-SUFFIX,plus.codes,Google",
        "DOMAIN-SUFFIX,polymer-project.org,Google",
        "DOMAIN-SUFFIX,polymerproject.org,Google",
        "DOMAIN-SUFFIX,postini.com,Google",
        "DOMAIN-SUFFIX,privacysandbox.com,Google",
        "DOMAIN-SUFFIX,prod-controlbe.floonet.goog,Google",
        "DOMAIN-SUFFIX,prod-databe.floonet.goog,Google",
        "DOMAIN-SUFFIX,prod.databe.floonet.goog,Google",
        "DOMAIN-SUFFIX,projectara.com,Google",
        "DOMAIN-SUFFIX,projectbaseline.com,Google",
        "DOMAIN-SUFFIX,publishproxy.com,Google",
        "DOMAIN-SUFFIX,qagpublic.qatp1.net,Google",
        "DOMAIN-SUFFIX,qgadmin.qcpp1.net,Google",
        "DOMAIN-SUFFIX,qiao-cn.com,Google",
        "DOMAIN-SUFFIX,qpx.googleflights.net,Google",
        "DOMAIN-SUFFIX,qualysapi.qatp1.net,Google",
        "DOMAIN-SUFFIX,qualysguard.qpdp1.net,Google",
        "DOMAIN-SUFFIX,questvisual.com,Google",
        "DOMAIN-SUFFIX,quickoffice.com,Google",
        "DOMAIN-SUFFIX,quiksee.com,Google",
        "DOMAIN-SUFFIX,recaptcha-cn.net,Google",
        "DOMAIN-SUFFIX,recaptcha.net,Google",
        "DOMAIN-SUFFIX,redhotlabs.com,Google",
        "DOMAIN-SUFFIX,redirector.gcpcdn.gvt1.com,Google",
        "DOMAIN-SUFFIX,redirector.gvt1.com,Google",
        "DOMAIN-SUFFIX,redirector.offline-maps.gvt1.com,Google",
        "DOMAIN-SUFFIX,redirector.snap.gvt1.com,Google",
        "DOMAIN-SUFFIX,registry.google,Google",
        "DOMAIN-SUFFIX,revolv.com,Google",
        "DOMAIN-SUFFIX,ridepenguin.com,Google",
        "DOMAIN-SUFFIX,run.app,Google",
        "DOMAIN-SUFFIX,savethedate.foo,Google",
        "DOMAIN-SUFFIX,saynow.com,Google",
        "DOMAIN-SUFFIX,scanservice1.qcpp1.net,Google",
        "DOMAIN-SUFFIX,schema.org,Google",
        "DOMAIN-SUFFIX,schemer.com,Google",
        "DOMAIN-SUFFIX,screenwisetrends.com,Google",
        "DOMAIN-SUFFIX,screenwisetrendspanel.com,Google",
        "DOMAIN-SUFFIX,shattered.io,Google",
        "DOMAIN-SUFFIX,snapseed.com,Google",
        "DOMAIN-SUFFIX,solveforx.com,Google",
        "DOMAIN-SUFFIX,stadia.dev,Google",
        "DOMAIN-SUFFIX,staging-controlbe.floonet.goog,Google",
        "DOMAIN-SUFFIX,staging-databe.floonet.goog,Google",
        "DOMAIN-SUFFIX,staging.databe.floonet.goog,Google",
        "DOMAIN-SUFFIX,stcroixmosquito.com,Google",
        "DOMAIN-SUFFIX,stcroixmosquitoproject.com,Google",
        "DOMAIN-SUFFIX,studywatchbyverily.com,Google",
        "DOMAIN-SUFFIX,studywatchbyverily.org,Google",
        "DOMAIN-SUFFIX,stxmosquito.com,Google",
        "DOMAIN-SUFFIX,stxmosquitoproject.com,Google",
        "DOMAIN-SUFFIX,stxmosquitoproject.net,Google",
        "DOMAIN-SUFFIX,stxmosquitoproject.org,Google",
        "DOMAIN-SUFFIX,synergyse.com,Google",
        "DOMAIN-SUFFIX,teachparentstech.org,Google",
        "DOMAIN-SUFFIX,tensorflow.org,Google",
        "DOMAIN-SUFFIX,tfhub.dev,Google",
        "DOMAIN-SUFFIX,thecleversense.com,Google",
        "DOMAIN-SUFFIX,thegooglestore.com,Google",
        "DOMAIN-SUFFIX,thinkquarterly.co.uk,Google",
        "DOMAIN-SUFFIX,thinkquarterly.com,Google",
        "DOMAIN-SUFFIX,thinkwithgoogle.com,Google",
        "DOMAIN-SUFFIX,tiltbrush.com,Google",
        "DOMAIN-SUFFIX,txcloud.net,Google",
        "DOMAIN-SUFFIX,txvia.com,Google",
        "DOMAIN-SUFFIX,unfiltered.news,Google",
        "DOMAIN-SUFFIX,urchin.com,Google",
        "DOMAIN-SUFFIX,useplannr.com,Google",
        "DOMAIN-SUFFIX,usvimosquito.com,Google",
        "DOMAIN-SUFFIX,usvimosquitoproject.com,Google",
        "DOMAIN-SUFFIX,v8.dev,Google",
        "DOMAIN-SUFFIX,v8project.org,Google",
        "DOMAIN-SUFFIX,velostrata.com,Google",
        "DOMAIN-SUFFIX,verily.com,Google",
        "DOMAIN-SUFFIX,verilylifesciences.com,Google",
        "DOMAIN-SUFFIX,verilystudyhub.com,Google",
        "DOMAIN-SUFFIX,verilystudywatch.com,Google",
        "DOMAIN-SUFFIX,verilystudywatch.org,Google",
        "DOMAIN-SUFFIX,wallet.com,Google",
        "DOMAIN-SUFFIX,waveprotocol.org,Google",
        "DOMAIN-SUFFIX,waymo.com,Google",
        "DOMAIN-SUFFIX,waze.com,Google",
        "DOMAIN-SUFFIX,web.app,Google",
        "DOMAIN-SUFFIX,web.dev,Google",
        "DOMAIN-SUFFIX,webappfieldguide.com,Google",
        "DOMAIN-SUFFIX,webmproject.org,Google",
        "DOMAIN-SUFFIX,webpkgcache.com,Google",
        "DOMAIN-SUFFIX,webrtc.org,Google",
        "DOMAIN-SUFFIX,weltweitwachsen.de,Google",
        "DOMAIN-SUFFIX,whatbrowser.org,Google",
        "DOMAIN-SUFFIX,widevine.com,Google",
        "DOMAIN-SUFFIX,withgoogle.com,Google",
        "DOMAIN-SUFFIX,womenwill.com,Google",
        "DOMAIN-SUFFIX,womenwill.com.br,Google",
        "DOMAIN-SUFFIX,womenwill.id,Google",
        "DOMAIN-SUFFIX,womenwill.in,Google",
        "DOMAIN-SUFFIX,womenwill.mx,Google",
        "DOMAIN-SUFFIX,www.destinationurl.com,Google",
        "DOMAIN-SUFFIX,www.pxcc.com,Google",
        "DOMAIN-SUFFIX,x.company,Google",
        "DOMAIN-SUFFIX,x.team,Google",
        "DOMAIN-SUFFIX,xn--9kr7l.com,Google",
        "DOMAIN-SUFFIX,xn--9trs65b.com,Google",
        "DOMAIN-SUFFIX,xn--flw351e.com,Google",
        "DOMAIN-SUFFIX,xn--ggle-55da.com,Google",
        "DOMAIN-SUFFIX,xn--gogl-0nd52e.com,Google",
        "DOMAIN-SUFFIX,xn--gogl-1nd42e.com,Google",
        "DOMAIN-SUFFIX,xn--ngstr-lra8j.com,Google",
        "DOMAIN-SUFFIX,xn--p8j9a0d9c9a.xn--q9jyb4c,Google",
        "DOMAIN-SUFFIX,xplr.co,Google",
        "DOMAIN-SUFFIX,zukunftswerkstatt.de,Google",
        "DOMAIN-SUFFIX,zynamics.com,Google",
        ...
        "IP-CIDR,172.110.32.0/21,Google,no-resolve",
        "IP-CIDR,173.194.0.0/16,Google,no-resolve",
        "IP-CIDR,216.73.80.0/20,Google,no-resolve",
        "IP-CIDR,74.125.0.0/16,Google,no-resolve",
        "IP-CIDR6,2620:120:e000::/40,Google,no-resolve",
        ...
        "DOMAIN,vsmarketplacebadge.apphb.com,Microsoft",
        "DOMAIN-SUFFIX,linkedin.com,Microsoft",
        "DOMAIN-SUFFIX,linkedin.cn,Microsoft",
        "DOMAIN-SUFFIX,1drv.ms,Microsoft",
        "DOMAIN-SUFFIX,21vbc.com,Microsoft",
        "DOMAIN-SUFFIX,21vbluecloud.com,Microsoft",
        "DOMAIN-SUFFIX,21vbluecloud.net,Microsoft",
        ...
        "DOMAIN-SUFFIX,aadrm.cn,Microsoft",
        ...
        "DOMAIN-SUFFIX,aggresmart.com,Microsoft",
        ...
        "DOMAIN-SUFFIX,apihub-internal.cn,Microsoft",
        ...
        "DOMAIN-SUFFIX,appserviceenvironment.cn,Microsoft",
        ...
        "DOMAIN-SUFFIX,azcrmc-test.cn,Microsoft",
        "DOMAIN-SUFFIX,azcrmc.cn,Microsoft",
        "DOMAIN-SUFFIX,azk8s.cn,Microsoft",
        "DOMAIN-SUFFIX,aznbcontent.cn,Microsoft",
        "DOMAIN-SUFFIX,aztask.cn,Microsoft",
        "DOMAIN-SUFFIX,azure,Microsoft",
        "DOMAIN-SUFFIX,azure-api.cn,Microsoft",
        "DOMAIN-SUFFIX,azure-apihub.cn,Microsoft",
        "DOMAIN-SUFFIX,azure-apim.net,Microsoft",
        "DOMAIN-SUFFIX,azure-automation.cn,Microsoft",
        "DOMAIN-SUFFIX,azure-connectedvehicles-stage.cn,Microsoft",
        "DOMAIN-SUFFIX,azure-connectedvehicles.cn,Microsoft",
        "DOMAIN-SUFFIX,azure-devices-int.net,Microsoft",
        "DOMAIN-SUFFIX,azure-devices-provisioning.cn,Microsoft",
        "DOMAIN-SUFFIX,azure-devices.cn,Microsoft",
        "DOMAIN-SUFFIX,azure-devices.net,Microsoft",
        "DOMAIN-SUFFIX,azure-dns.cn,Microsoft",
        ...
        "DOMAIN-SUFFIX,azurecomm.net,Microsoft",
        ...
        "DOMAIN-SUFFIX,azurecr-test.cn,Microsoft",
        "DOMAIN-SUFFIX,azurecr.cn,Microsoft",
        ...
        "DOMAIN-SUFFIX,b2clogin.cn,Microsoft",
        "DOMAIN-SUFFIX,b3itech.cn,Microsoft",
        ...
        "DOMAIN-SUFFIX,blueaggrestore.com,Microsoft",
        "DOMAIN-SUFFIX,bluecloudprod.com,Microsoft",
        ...
        "DOMAIN-SUFFIX,doom.com,Microsoft",
        "DOMAIN-SUFFIX,dot.net,Microsoft",
        "DOMAIN-SUFFIX,dwh5.com,Microsoft",
        "DOMAIN-SUFFIX,dynamics.cn,Microsoft",
        ...
        "DOMAIN-SUFFIX,elderscrolls.com,Microsoft",
        ...
        "DOMAIN-SUFFIX,hdinsightservices.cn,Microsoft",
        ...
        "DOMAIN-SUFFIX,livetileedge.dsx.mp.microsoft.com.edgekey.net,Microsoft",
        ...
        "DOMAIN-SUFFIX,management-azure-devices-int.net,Microsoft",
        "DOMAIN-SUFFIX,management-azure-devices.net,Microsoft",
        "DOMAIN-SUFFIX,mapblast.com,Microsoft",
        "DOMAIN-SUFFIX,mappoint.com,Microsoft",
        "DOMAIN-SUFFIX,masalladeloslimites.com,Microsoft",
        "DOMAIN-SUFFIX,mcchcdn.com,Microsoft",
        ...
        "DOMAIN-SUFFIX,mgmt-azure-api.cn,Microsoft",
        "DOMAIN-SUFFIX,microbit.org,Microsoft",
        "DOMAIN-SUFFIX,microsoft,Microsoft",
        "DOMAIN-SUFFIX,microsoft-falcon.io,Microsoft",
        ...
        "DOMAIN-SUFFIX,microsoftapp.net,Microsoft",
        "DOMAIN-SUFFIX,microsoftazuread-sso.com,Microsoft",
        "DOMAIN-SUFFIX,microsoftazuresponsorships.com,Microsoft",
        "DOMAIN-SUFFIX,microsoftazurestatus.cn,Microsoft",
        ...
        "DOMAIN-SUFFIX,microsoftmetrics.cn,Microsoft",
        ...
        "DOMAIN-SUFFIX,microsoftonline-i.cn,Microsoft",
        "DOMAIN-SUFFIX,microsoftonline-m-i.cn,Microsoft",
        "DOMAIN-SUFFIX,microsoftonline-m.cn,Microsoft",
        "DOMAIN-SUFFIX,microsoftonline-p-i.cn,Microsoft",
        "DOMAIN-SUFFIX,microsoftonline-p-i.net.cn,Microsoft",
        "DOMAIN-SUFFIX,microsoftonline-p.cn,Microsoft",
        "DOMAIN-SUFFIX,microsoftonline-p.com,Microsoft",
        "DOMAIN-SUFFIX,microsoftonline-p.net,Microsoft",
        "DOMAIN-SUFFIX,microsoftonline-p.net.cn,Microsoft",
        "DOMAIN-SUFFIX,microsoftonline.cn,Microsoft",
        ...
        "DOMAIN-SUFFIX,microsoftstart.com,Microsoft",
        ...
        "DOMAIN-SUFFIX,microsofttranslator-int.cn,Microsoft",
        ...
        "DOMAIN-SUFFIX,mncmsidlab1.cn,Microsoft",
        ...
        "DOMAIN-SUFFIX,msidentity.cn,Microsoft",
        "DOMAIN-SUFFIX,msidentity.com,Microsoft",
        "DOMAIN-SUFFIX,msidlabpbmc.cn,Microsoft",
        ...
        "DOMAIN-SUFFIX,msn.net,Microsoft",
        ...
        "DOMAIN-SUFFIX,office365-net.cn,Microsoft",
        "DOMAIN-SUFFIX,office365.cn,Microsoft",
        ...
        "DOMAIN-SUFFIX,officewebapps.cn,Microsoft",
        ...
        "DOMAIN-SUFFIX,onmschina.cn,Microsoft",
        ...
        "DOMAIN-SUFFIX,pbiwebcontent.cn,Microsoft",
        ...
        "DOMAIN-SUFFIX,powerapps.cn,Microsoft",
        "DOMAIN-SUFFIX,powerappscdn.net,Microsoft",
        "DOMAIN-SUFFIX,powerappsportals.cn,Microsoft",
        "DOMAIN-SUFFIX,powerautomate.cn,Microsoft",
        "DOMAIN-SUFFIX,powerautomate.com,Microsoft",
        "DOMAIN-SUFFIX,powerbi.cn,Microsoft",
        ...
        "DOMAIN-SUFFIX,start.com,Microsoft",
        ...
        "DOMAIN-SUFFIX,windows,Microsoft",
        ...
        "DOMAIN-SUFFIX,windowsazurestatus.cn,Microsoft",
        ...
        "DOMAIN-SUFFIX,apple-ready.fastly-edge.com,OpenAI",
        "DOMAIN-SUFFIX,apple-relay.apple.com,OpenAI",
        "DOMAIN-SUFFIX,apple-relay.cloudflare.com,OpenAI",
        "DOMAIN-SUFFIX,cp4.cloudflare.com,OpenAI",
        "DOMAIN-SUFFIX,gateway.icloud.com,OpenAI",
        "DOMAIN-SUFFIX,guzzoni.apple.com,OpenAI",
        "DOMAIN-SUFFIX,gspe1-ssl.ls.apple.com,OpenAI",
        "DOMAIN-SUFFIX,smoot.apple.com,OpenAI",
        ...
        "DOMAIN,fpinit.itunes.apple.com,Apple",
        ...
        "PROCESS-NAME,storedownloadd,Apple",
        "PROCESS-NAME,Music,Apple",
        "PROCESS-NAME,News,Apple",
        "PROCESS-NAME,TV,Apple",
        ...
        "DOMAIN-SUFFIX,ak1.net,Proxies",
        "DOMAIN-SUFFIX,aka-ai.com,Proxies",
        "DOMAIN-SUFFIX,aka-ai.net,Proxies",
        "DOMAIN-SUFFIX,akacrypto.net,Proxies",
        "DOMAIN-SUFFIX,akadeem.net,Proxies",
        "DOMAIN-SUFFIX,akadns.com,Proxies",
        "DOMAIN-SUFFIX,akadns6.net,Proxies",
        "DOMAIN-SUFFIX,akaeai.com,Proxies",
        "DOMAIN-SUFFIX,akafms.net,Proxies",
        "DOMAIN-SUFFIX,akahost.net,Proxies",
        "DOMAIN-SUFFIX,akaint.net,Proxies",
        "DOMAIN-SUFFIX,akam.net,Proxies",
        "DOMAIN-SUFFIX,akamaa.com,Proxies",
        "DOMAIN-SUFFIX,akamah.com,Proxies",
        "DOMAIN-SUFFIX,akamai-access.com,Proxies",
        "DOMAIN-SUFFIX,akamai-access.net,Proxies",
        "DOMAIN-SUFFIX,akamai-cdn.com,Proxies",
        "DOMAIN-SUFFIX,akamai-platform-internal.net,Proxies",
        "DOMAIN-SUFFIX,akamai-platform-staging.com,Proxies",
        "DOMAIN-SUFFIX,akamai-platform.net,Proxies",
        "DOMAIN-SUFFIX,akamai-regression.net,Proxies",
        "DOMAIN-SUFFIX,akamai-staging.net,Proxies",
        "DOMAIN-SUFFIX,akamai-sucks.net,Proxies",
        "DOMAIN-SUFFIX,akamai-thailand.com,Proxies",
        "DOMAIN-SUFFIX,akamai-thailand.net,Proxies",
        "DOMAIN-SUFFIX,akamai-trials.com,Proxies",
        "DOMAIN-SUFFIX,akamai.co.kr,Proxies",
        "DOMAIN-SUFFIX,akamai.com,Proxies",
        "DOMAIN-SUFFIX,akamai.net,Proxies",
        "DOMAIN-SUFFIX,akamaiedge.net,Proxies",
        "DOMAIN-SUFFIX,akamaientrypoint.net,Proxies",
        "DOMAIN-SUFFIX,akamaietpcnctest.com,Proxies",
        "DOMAIN-SUFFIX,akamaietpcompromisedcnctest.com,Proxies",
        "DOMAIN-SUFFIX,akamaietpcompromisedmalwaretest.com,Proxies",
        "DOMAIN-SUFFIX,akamaietpmalwaretest.com,Proxies",
        "DOMAIN-SUFFIX,akamaietpphishingtest.com,Proxies",
        "DOMAIN-SUFFIX,akamaihd-staging.net,Proxies",
        "DOMAIN-SUFFIX,akamaihd.com,Proxies",
        "DOMAIN-SUFFIX,akamaihd.net,Proxies",
        "DOMAIN-SUFFIX,akamaimagicmath.net,Proxies",
        "DOMAIN-SUFFIX,akamainewzealand.com,Proxies",
        "DOMAIN-SUFFIX,akamaiphillipines.com,Proxies",
        "DOMAIN-SUFFIX,akamaiphillipines.net,Proxies",
        "DOMAIN-SUFFIX,akamaisingapore.net,Proxies",
        "DOMAIN-SUFFIX,akamaistream.net,Proxies",
        "DOMAIN-SUFFIX,akamaitech.com,Proxies",
        "DOMAIN-SUFFIX,akamaitech.net,Proxies",
        "DOMAIN-SUFFIX,akamaitechnologies.com,Proxies",
        "DOMAIN-SUFFIX,akamaitechnologies.net,Proxies",
        "DOMAIN-SUFFIX,akamaized-staging.net,Proxies",
        "DOMAIN-SUFFIX,akamaized.net,Proxies",
        "DOMAIN-SUFFIX,akamaizercentral.com,Proxies",
        "DOMAIN-SUFFIX,akamak.com,Proxies",
        "DOMAIN-SUFFIX,akamam.com,Proxies",
        "DOMAIN-SUFFIX,akamci.com,Proxies",
        "DOMAIN-SUFFIX,akami.com,Proxies",
        "DOMAIN-SUFFIX,akami.net,Proxies",
        "DOMAIN-SUFFIX,akamii.com,Proxies",
        "DOMAIN-SUFFIX,akamqi.com,Proxies",
        "DOMAIN-SUFFIX,akastream.com,Proxies",
        "DOMAIN-SUFFIX,akastream.net,Proxies",
        "DOMAIN-SUFFIX,akatns.net,Proxies",
        "DOMAIN-SUFFIX,iamakamai.com,Proxies",
        "DOMAIN-SUFFIX,iamakamai.net,Proxies",
        "DOMAIN-SUFFIX,soasta-dswb.com,Proxies",
        "DOMAIN-SUFFIX,srtcdn.net,Proxies",
        "DOMAIN-SUFFIX,a2z.com,Proxies",
        "DOMAIN-SUFFIX,aboutamazon.co.uk,Proxies",
        "DOMAIN-SUFFIX,aboutamazon.com,Proxies",
        "DOMAIN-SUFFIX,aboutamazon.com.au,Proxies",
        "DOMAIN-SUFFIX,aboutamazon.de,Proxies",
        "DOMAIN-SUFFIX,aboutamazon.es,Proxies",
        "DOMAIN-SUFFIX,aboutamazon.eu,Proxies",
        "DOMAIN-SUFFIX,aboutamazon.fr,Proxies",
        "DOMAIN-SUFFIX,aboutamazon.in,Proxies",
        "DOMAIN-SUFFIX,aboutamazon.it,Proxies",
        "DOMAIN-SUFFIX,aboutamazon.jp,Proxies",
        "DOMAIN-SUFFIX,aboutamazon.pl,Proxies",
        "DOMAIN-SUFFIX,acmvalidations.com,Proxies",
        "DOMAIN-SUFFIX,acmvalidationsaws.com,Proxies",
        "DOMAIN-SUFFIX,aesworkshops.com,Proxies",
        "DOMAIN-SUFFIX,aiv-cdn.net,Proxies",
        "DOMAIN-SUFFIX,aiv-delivery.net,Proxies",
        "DOMAIN-SUFFIX,alexa.com,Proxies",
        "DOMAIN-SUFFIX,amaaozn.com,Proxies",
        "DOMAIN-SUFFIX,amazon,Proxies",
        "DOMAIN-SUFFIX,amazon-adsystem.com,Proxies",
        "DOMAIN-SUFFIX,amazon-fashions.com,Proxies",
        "DOMAIN-SUFFIX,amazon-jp-recruiting.com,Proxies",
        "DOMAIN-SUFFIX,amazon-lantern.com,Proxies",
        "DOMAIN-SUFFIX,amazon-launchpad.com,Proxies",
        "DOMAIN-SUFFIX,amazon.ae,Proxies",
        "DOMAIN-SUFFIX,amazon.ca,Proxies",
        "DOMAIN-SUFFIX,amazon.co.jp,Proxies",
        "DOMAIN-SUFFIX,amazon.co.uk,Proxies",
        "DOMAIN-SUFFIX,amazon.com,Proxies",
        "DOMAIN-SUFFIX,amazon.com.au,Proxies",
        "DOMAIN-SUFFIX,amazon.com.br,Proxies",
        "DOMAIN-SUFFIX,amazon.com.mx,Proxies",
        "DOMAIN-SUFFIX,amazon.com.tr,Proxies",
        "DOMAIN-SUFFIX,amazon.de,Proxies",
        "DOMAIN-SUFFIX,amazon.es,Proxies",
        "DOMAIN-SUFFIX,amazon.fr,Proxies",
        "DOMAIN-SUFFIX,amazon.in,Proxies",
        "DOMAIN-SUFFIX,amazon.it,Proxies",
        "DOMAIN-SUFFIX,amazon.jobs,Proxies",
        "DOMAIN-SUFFIX,amazon.jp,Proxies",
        "DOMAIN-SUFFIX,amazon.nl,Proxies",
        "DOMAIN-SUFFIX,amazon.red,Proxies",
        "DOMAIN-SUFFIX,amazon.sg,Proxies",
        "DOMAIN-SUFFIX,amazonalexavoxcon.com,Proxies",
        "DOMAIN-SUFFIX,amazonauthorinsights.com,Proxies",
        "DOMAIN-SUFFIX,amazonaws.co.uk,Proxies",
        "DOMAIN-SUFFIX,amazonaws.com,Proxies",
        "DOMAIN-SUFFIX,amazonaws.tv,Proxies",
        "DOMAIN-SUFFIX,amazonbusiness.org,Proxies",
        "DOMAIN-SUFFIX,amazonbusinessblog.com,Proxies",
        "DOMAIN-SUFFIX,amazondevicesupport.com,Proxies",
        "DOMAIN-SUFFIX,amazonfctours.com,Proxies",
        "DOMAIN-SUFFIX,amazonianblog.com,Proxies",
        "DOMAIN-SUFFIX,amazonimages.com,Proxies",
        "DOMAIN-SUFFIX,amazonlaunchpad.com,Proxies",
        "DOMAIN-SUFFIX,amazonliterarypartnership.com,Proxies",
        "DOMAIN-SUFFIX,amazonlumberyard.wang,Proxies",
        "DOMAIN-SUFFIX,amazonpay.com,Proxies",
        "DOMAIN-SUFFIX,amazonpay.in,Proxies",
        "DOMAIN-SUFFIX,amazonprimevideos.com,Proxies",
        "DOMAIN-SUFFIX,amazonsdi.com,Proxies",
        "DOMAIN-SUFFIX,amazonses.com,Proxies",
        "DOMAIN-SUFFIX,amazonstudiosguilds.com,Proxies",
        "DOMAIN-SUFFIX,amazontrust.com,Proxies",
        "DOMAIN-SUFFIX,amazonuniversity.jobs,Proxies",
        "DOMAIN-SUFFIX,amazonvideo.cc,Proxies",
        "DOMAIN-SUFFIX,amazonvideo.com,Proxies",
        "DOMAIN-SUFFIX,amazonvideodirect.com,Proxies",
        "DOMAIN-SUFFIX,amplifyapp.com,Proxies",
        "DOMAIN-SUFFIX,amplifyframework.com,Proxies",
        "DOMAIN-SUFFIX,amzn.asia,Proxies",
        "DOMAIN-SUFFIX,amzn.com,Proxies",
        "DOMAIN-SUFFIX,amzn.to,Proxies",
        "DOMAIN-SUFFIX,amznl.com,Proxies",
        "DOMAIN-SUFFIX,associates-amazon.com,Proxies",
        "DOMAIN-SUFFIX,audible.com,Proxies",
        "DOMAIN-SUFFIX,avodmp4s3ww-a.akamaihd.net,Proxies",
        "DOMAIN-SUFFIX,aws,Proxies",
        "DOMAIN-SUFFIX,aws-iot-hackathon.com,Proxies",
        "DOMAIN-SUFFIX,awsautopilot.com,Proxies",
        "DOMAIN-SUFFIX,awsautoscaling.com,Proxies",
        "DOMAIN-SUFFIX,awsbraket.com,Proxies",
        "DOMAIN-SUFFIX,awscloud.com,Proxies",
        "DOMAIN-SUFFIX,awscommandlineinterface.com,Proxies",
        "DOMAIN-SUFFIX,awsedstart.com,Proxies",
        "DOMAIN-SUFFIX,awseducate.com,Proxies",
        "DOMAIN-SUFFIX,awseducate.net,Proxies",
        "DOMAIN-SUFFIX,awseducate.org,Proxies",
        "DOMAIN-SUFFIX,awsglobalaccelerator.com,Proxies",
        "DOMAIN-SUFFIX,awsloft-johannesburg.com,Proxies",
        "DOMAIN-SUFFIX,awsloft-stockholm.com,Proxies",
        "DOMAIN-SUFFIX,awssecworkshops.com,Proxies",
        "DOMAIN-SUFFIX,awsstatic.com,Proxies",
        "DOMAIN-SUFFIX,awsthinkbox.com,Proxies",
        "DOMAIN-SUFFIX,awstrack.me,Proxies",
        "DOMAIN-SUFFIX,awstrust.com,Proxies",
        "DOMAIN-SUFFIX,boxofficemojo.com,Proxies",
        "DOMAIN-SUFFIX,cdkworkshop.com,Proxies",
        "DOMAIN-SUFFIX,cloudfront.net,Proxies",
        "DOMAIN-SUFFIX,containersonaws.com,Proxies",
        "DOMAIN-SUFFIX,createspace.com,Proxies",
        "DOMAIN-SUFFIX,elasticbeanstalk.com,Proxies",
        "DOMAIN-SUFFIX,gameon-masters.com,Proxies",
        "DOMAIN-SUFFIX,gdansk-amazon.com,Proxies",
        "DOMAIN-SUFFIX,images-amazon.com,Proxies",
        "DOMAIN-SUFFIX,imdb,Proxies",
        "DOMAIN-SUFFIX,imdb.com,Proxies",
        "DOMAIN-SUFFIX,imdb.to,Proxies",
        "DOMAIN-SUFFIX,kindle,Proxies",
        "DOMAIN-SUFFIX,kindle.co.jp,Proxies",
        "DOMAIN-SUFFIX,kindle.co.uk,Proxies",
        "DOMAIN-SUFFIX,kindle.com,Proxies",
        "DOMAIN-SUFFIX,kindle.de,Proxies",
        "DOMAIN-SUFFIX,kindle.es,Proxies",
        "DOMAIN-SUFFIX,kindle.fr,Proxies",
        "DOMAIN-SUFFIX,kindle.in,Proxies",
        "DOMAIN-SUFFIX,kindle.it,Proxies",
        "DOMAIN-SUFFIX,kindle.jp,Proxies",
        "DOMAIN-SUFFIX,kindleoasis.com,Proxies",
        "DOMAIN-SUFFIX,kindleoasis.info,Proxies",
        "DOMAIN-SUFFIX,kindleoasis.jp,Proxies",
        "DOMAIN-SUFFIX,kindleoasis.org,Proxies",
        "DOMAIN-SUFFIX,kindleoasis.us,Proxies",
        "DOMAIN-SUFFIX,kindleoasisnews.com,Proxies",
        "DOMAIN-SUFFIX,kindleproject.com,Proxies",
        "DOMAIN-SUFFIX,llnwd.net,Proxies",
        "DOMAIN-SUFFIX,media-amazon.com,Proxies",
        "DOMAIN-SUFFIX,media-imdb.com,Proxies",
        "DOMAIN-SUFFIX,prime-video.com,Proxies",
        "DOMAIN-SUFFIX,primeday.info,Proxies",
        "DOMAIN-SUFFIX,primevideo.cc,Proxies",
        "DOMAIN-SUFFIX,primevideo.com,Proxies",
        "DOMAIN-SUFFIX,primevideo.info,Proxies",
        "DOMAIN-SUFFIX,primevideo.org,Proxies",
        "DOMAIN-SUFFIX,primevideo.tv,Proxies",
        "DOMAIN-SUFFIX,pv-cdn.net,Proxies",
        "DOMAIN-SUFFIX,seattlespheres.com,Proxies",
        "DOMAIN-SUFFIX,serving-sys.com,Proxies",
        "DOMAIN-SUFFIX,siege-amazon.com,Proxies",
        "DOMAIN-SUFFIX,ss2.us,Proxies",
        "DOMAIN-SUFFIX,ssl-images-amazon.com,Proxies",
        "DOMAIN-SUFFIX,thinkboxsoftware.com,Proxies",
        "DOMAIN-SUFFIX,ueberamazon.de,Proxies",
        "DOMAIN-SUFFIX,wfm.com,Proxies",
        "DOMAIN-SUFFIX,wholecitiesfoundation.org,Proxies",
        "DOMAIN-SUFFIX,wholefoods.com,Proxies",
        "DOMAIN-SUFFIX,wholefoodsmarket.co.uk,Proxies",
        "DOMAIN-SUFFIX,wholefoodsmarket.com,Proxies",
        "DOMAIN-SUFFIX,wholekidsfoundation.org,Proxies",
        "DOMAIN-SUFFIX,wholeplanetfoundation.org,Proxies",
        "DOMAIN-SUFFIX,xn--cckwcxetd,Proxies",
        "DOMAIN-SUFFIX,xn--jlq480n2rg,Proxies",
        "DOMAIN-SUFFIX,yamaxun,Proxies",
        "DOMAIN-SUFFIX,yamaxun.com,Proxies",
        "DOMAIN-SUFFIX,zappos,Proxies",
        ...
        "PROCESS-NAME,com.amazon.avod.thirdpartyclient,Proxies",
        ...
        "DOMAIN-SUFFIX,comments.app,Proxies",
        "DOMAIN-SUFFIX,contest.com,Proxies",
        "DOMAIN-SUFFIX,graph.org,Proxies",
        "DOMAIN-SUFFIX,mbrx.app,Proxies",
        "DOMAIN-SUFFIX,quiz.directory,Proxies",
        "DOMAIN-SUFFIX,stel.com,Proxies",
        "DOMAIN-SUFFIX,tdesktop.com,Proxies",
        "DOMAIN-SUFFIX,telega.one,Proxies",
        "DOMAIN-SUFFIX,telegra.ph,Proxies",
        "DOMAIN-SUFFIX,telegram-cdn.org,Proxies",
        "DOMAIN-SUFFIX,telegram.dog,Proxies",
        "DOMAIN-SUFFIX,telegram.me,Proxies",
        "DOMAIN-SUFFIX,telegram.space,Proxies",
        "DOMAIN-SUFFIX,telegramdownload.com,Proxies",
        "DOMAIN-SUFFIX,telesco.pe,Proxies",
        "DOMAIN-SUFFIX,tg.dev,Proxies",
        "DOMAIN-SUFFIX,tx.me,Proxies",
        "DOMAIN-SUFFIX,usercontent.dev,Proxies",
        "DOMAIN-KEYWORD,nicegram,Proxies",
        "IP-CIDR,149.154.160.0/20,Proxies,no-resolve",
        "IP-CIDR,109.239.140.0/24,Proxies,no-resolve",
        "IP-CIDR,5.28.195.163/32,Proxies,no-resolve",
        "IP-CIDR,5.28.195.205/32,Proxies,no-resolve",
        "IP-CIDR,5.28.195.37/32,Proxies,no-resolve",
        "IP-CIDR,91.108.0.0/16,Proxies,no-resolve",
        "IP-CIDR6,2001:67c:4e8::/48,Proxies,no-resolve",
        "IP-CIDR6,2001:b28:f23c::/47,Proxies,no-resolve",
        "IP-CIDR6,2001:b28:f23f::/48,Proxies,no-resolve",
        "IP-CIDR6,2a0a:f280::/32,Proxies,no-resolve",
        "PROCESS-NAME,nekox.messenger,Proxies",
        "PROCESS-NAME,org.telegram.messenger,Proxies",
        "PROCESS-NAME,telegram-desktop,Proxies",
